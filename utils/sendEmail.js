exports.registerOTP = (otp, name) => {
  ...
  <head>
    ...
    <title>SkyPulse Email Verification</title>
  ...
  <body>
    <div class="wrapper">
      <div class="card">
        ...
        <div class="title">Verify Your SkyPulse Account</div>
        ...
        <div class="footer">
          © ${new Date().getFullYear()} SkyPulse — Modular Backend Infrastructure System
        </div>
      </div>
    </div>
  </body>
